                    ...
                    >
                        {planData.map((plan, index) => (
                            <SwiperSlide key={index}>
                                <div className="p-6 bg-white rounded-xl flex flex-row items-center gap-4">
                        ...
                        {planData.map((plan, index) => (
                            <SwiperSlide key={index}>
                                <div
                                    ...
                                    className={`p-4 rounded-xl shadow-md flex flex-col items-center cursor-pointer ${activeIndex === index
